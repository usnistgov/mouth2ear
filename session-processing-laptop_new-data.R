...
oneLoc <- list(
  ...
  path = "C:/Users/jkp4/Documents/MCV/Processed-Data/1loc/delay_values",
  tests = c(
  ...
  twoLoc.lab <- list(
    ...
    path = "C:/Users/jkp4/Documents/MCV/Processed-Data/2loc/delay_values",
    tests = c(
     ...
     if(nrow(test.dat)>2){
       ...
       for(i in 1:(nrow(test.dat)-1)){
         for(j in (i+1):nrow(test.dat)){
           ...
           if(comp$y-comp$U<0 & comp$y + comp$U >0){
